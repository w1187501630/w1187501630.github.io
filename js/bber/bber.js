...
if (pathName === '/') {
  $(document).ready(function(){
      if ( $("#bber-talk").length > 0 ) {
        var jsonUrl = ''
        jsonUrl = "https://6865-hexo-2grwoqig8b0cefeb-1251887305.tcb.qcloud.la/json/bber.json?sign=97fbb569bcfec2a8c5fa6fe6ac2367fd&t=1651661767"
        $.getJSON(jsonUrl+"?t="+Date.parse( new Date()),function(res){
          ...
          $.each(res.data, function(i, item){
            ...
            bberHtml += '<li class="item item-'+(i+1)+'">'+'<a href="http://localhost:4000/Mybber/" style="color: var(--font-color);/*font-weight: normal;*/">'+newdataTime+'： '+urlToLink(item.content)+'</a></li>'
          });
